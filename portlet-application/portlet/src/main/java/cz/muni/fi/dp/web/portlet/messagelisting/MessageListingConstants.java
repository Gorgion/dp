 ...
 */
public class MessageListingConstants extends Constants {

    public static final String VIEW_MAIN = "documentlisting/view";


    public static final String ATTR_ALL_MESSAGES = "allItems";
    public static final String ATTR_MESSAGE_DTO = "messageDto";
